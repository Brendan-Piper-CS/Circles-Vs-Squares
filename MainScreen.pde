void mainScreen () {
  ...
  ellipse(displayWidth*3.8/5, displayHeight*3.6/5, displayWidth/10, displayWidth/10);//Enemy Circle
   ...
   //words
   fill(0);
   text(words[w], displayWidth/5.4, displayHeight*7/8); // Displays a random word for the player 
   text(words[w2], displayWidth*2.85/4, displayHeight*7/8); // Displays a random word for the computer
   //Inuts
   text(input, displayWidth/5.4, displayHeight*1.8/3); // Displays the text inputed by the player
   text(input2, displayWidth*2.85/4, displayHeight*1.8/3);// Displays the text inputed by the computer
